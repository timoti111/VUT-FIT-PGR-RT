...
#define NUM_PATHS 2 << 18
#define UINTMAXINV 0.0000000002328306436538696
#define HEMISPHERE_PDF 0.781592641796772029527
#define SPHERE_PDF 0.620350490899400016668
#define BXDF_DIFFUSE 1 << 1
#define BXDF_IDEAL_REFLECTION 1 << 2
#define BXDF_IDEAL_DIELECTRIC 1 << 3
#define BXDF_EMISSIVE 1 << 4
#define BXDF_IS_SPECULAR(t) ((t & (BXDF_IDEAL_REFLECTION | BXDF_IDEAL_DIELECTRIC)) != 0)
